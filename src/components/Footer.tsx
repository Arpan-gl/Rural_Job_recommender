        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-400 mb-4">
              AI-powered job recommendations for rural youth. Find jobs that match your skills instantly.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/assistant" className="hover:text-blue-400 transition-colors">
                  Assistant
                </Link>
              </li>
            </ul>
